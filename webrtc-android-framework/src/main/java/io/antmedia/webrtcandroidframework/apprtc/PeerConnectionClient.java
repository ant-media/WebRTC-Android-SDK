...
public class PeerConnectionClient {
    ...
    public static class PeerConnectionParameters {
        ...
        public PeerConnectionParameters(boolean videoCallEnabled, boolean loopback, boolean tracing,
                                        ...
                                        boolean useLegacyAudioDevice, DataChannelParameters dataChannelParameters, boolean audioCallEnabled) {
    ...
    private void createPeerConnectionFactoryInternal(PeerConnectionFactory.Options options) {
        ...
        if (peerConnectionParameters.videoCodecHwAcceleration) {
            ...
            for (VideoCodecInfo supportedCodec : supportedCodecs) {
                Log.i(this.getClass().getSimpleName(), "supported encoder: " + supportedCodec.name);
            }
            decoderFactory = new DefaultVideoDecoderFactory(rootEglBase.getEglBaseContext());

            supportedCodecs = decoderFactory.getSupportedCodecs();
            for (VideoCodecInfo supportedCodec : supportedCodecs) {
                Log.i(this.getClass().getSimpleName(), "supported decoder: " + supportedCodec.name);
            }
    ...
    private void createPeerConnectionInternal() {
        ...
        if (isAudioEnabled())
        {
            //we have added this isAudioEnabled to not send audio while playing

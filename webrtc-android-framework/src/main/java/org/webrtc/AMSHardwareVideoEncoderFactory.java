...
public class AMSHardwareVideoEncoderFactory implements VideoEncoderFactory {
     ...
     */
    public AMSHardwareVideoEncoderFactory(
     ...
     */
    public AMSHardwareVideoEncoderFactory(EglBase.Context sharedContext, boolean enableIntelVp8Encoder,
    ...
    @Deprecated
    public AMSHardwareVideoEncoderFactory(boolean enableIntelVp8Encoder, boolean enableH264HighProfile) {

...
public class JavaAudioDeviceModule implements AudioDeviceModule {
  ...
  public static class Builder {
    ...
    private int audioTrackContentType = -1;
    ...
    public Builder setAudioTrackContentType(int contentType) {
      this.audioTrackContentType = contentType;
      return this;
    }
    ...
    public AudioDeviceModule createAudioDeviceModule() {
      ...
      final WebRtcAudioTrack audioOutput =
          new WebRtcAudioTrack(context, audioManager, audioTrackErrorCallback, audioTrackContentType);
